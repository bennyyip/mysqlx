defmodule Mysqlx.RowParser do
  ...
  defp type_to_atom({:integer, :field_type_tiny}, flags)
       when (@unsigned_flag &&& flags) == @unsigned_flag do
    :uint8
  end
  ...
  defp type_to_atom({:integer, :field_type_short}, flags)
       when (@unsigned_flag &&& flags) == @unsigned_flag do
    :uint16
  end
  ...
  defp type_to_atom({:integer, :field_type_int24}, flags)
       when (@unsigned_flag &&& flags) == @unsigned_flag do
    :uint32
  end
  ...
  defp type_to_atom({:integer, :field_type_long}, flags)
       when (@unsigned_flag &&& flags) == @unsigned_flag do
    :uint32
  end
  ...
  defp type_to_atom({:integer, :field_type_longlong}, flags)
       when (@unsigned_flag &&& flags) == @unsigned_flag do
    :uint64
  end
  ...
  defp decode_bin_rows(<<rest::bits>>, [_ | fields], nullint, acc, json_library)
       when (nullint &&& 1) === 1 do
  ...
  defp decode_bin_rows(<<>>, [], _, acc, _json_library) do
    Enum.reverse(acc)
  end

  defp decode_string(
         <<len::8, string::size(len)-binary, rest::bits>>,
         fields,
         nullint,
         acc,
         json_library
  ...
  defp decode_string(
         <<252::8, len::16-little, string::size(len)-binary, rest::bits>>,
         fields,
         nullint,
         acc,
         json_library
  ...
  defp decode_string(
         <<253::8, len::24-little, string::size(len)-binary, rest::bits>>,
         fields,
         nullint,
         acc,
         json_library
  ...
  defp decode_string(
         <<254::8, len::64-little, string::size(len)-binary, rest::bits>>,
         fields,
         nullint,
         acc,
         json_library
  ...
  defp decode_float32(
         <<value::size(32)-float-little, rest::bits>>,
         fields,
         null_bitfield,
         acc,
         json_library
  ...
  defp decode_float64(
         <<value::size(64)-float-little, rest::bits>>,
         fields,
         null_bitfield,
         acc,
         json_library
  ...
  defp decode_uint8(
         <<value::size(8)-little-unsigned, rest::bits>>,
         fields,
         null_bitfield,
         acc,
         json_library
  ...
  defp decode_int8(
         <<value::size(8)-little-signed, rest::bits>>,
         fields,
         null_bitfield,
         acc,
         json_library
  ...
  defp decode_uint16(
         <<value::size(16)-little-unsigned, rest::bits>>,
         fields,
         null_bitfield,
         acc,
         json_library
  ...
  defp decode_int16(
         <<value::size(16)-little-signed, rest::bits>>,
         fields,
         null_bitfield,
         acc,
         json_library
  ...
  defp decode_uint32(
         <<value::size(32)-little-unsigned, rest::bits>>,
         fields,
         null_bitfield,
         acc,
         json_library
  ...
  defp decode_int32(
         <<value::size(32)-little-signed, rest::bits>>,
         fields,
         null_bitfield,
         acc,
         json_library
  ...
  defp decode_uint64(
         <<value::size(64)-little-unsigned, rest::bits>>,
         fields,
         null_bitfield,
         acc,
         json_library
  ...
  defp decode_int64(
         <<value::size(64)-little-signed, rest::bits>>,
         fields,
         null_bitfield,
         acc,
         json_library
  ...
  defp decode_decimal(
         <<length, raw_value::size(length)-little-binary, rest::bits>>,
         fields,
         null_bitfield,
         acc,
         json_library
  ...
  defp decode_time(
    ...
    decode_bin_rows(rest, fields, null_bitfield, [time | acc], json_library)
  end

  defp decode_time(
         <<8::8-little, _::8-little, _::32-little, hour::8-little,
           min::8-little, sec::8-little, rest::bits>>,
         fields,
         null_bitfield,
         acc,
         json_library
  ...
  defp decode_time(
         <<12::8, _::32-little, _::8-little, hour::8-little, min::8-little,
           sec::8-little, msec::32-little, rest::bits>>,
         fields,
         null_bitfield,
         acc,
         json_library
  ...
  defp decode_date(
    ...
    decode_bin_rows(rest, fields, null_bitfield, [date | acc], json_library)
  end

  defp decode_date(
         <<4::8-little, year::16-little, month::8-little, day::8-little,
           rest::bits>>,
         fields,
         null_bitfield,
         acc,
  ...
  defp decode_datetime(
    ...
    decode_bin_rows(rest, fields, null_bitfield, [datetime | acc], json_library)
  end
  ...
  defp decode_datetime(
         <<7::8-little, year::16-little, month::8-little, day::8-little,
           hour::8-little, min::8-little, sec::8-little, rest::bits>>,
         fields,
         null_bitfield,
         acc,
         json_library
  ...
  defp decode_datetime(
         <<11::8-little, year::16-little, month::8-little, day::8-little,
           hour::8-little, min::8-little, sec::8-little, msec::32-little,
           rest::bits>>,
         fields,
         null_bitfield,
         acc,
  ...
  #   decode_bin_rows(rest, fields, null_bitfield, [%Mysqlx.Geometry.Point{srid: srid, coordinates: {x, y}} | acc],  json_library)
  # end
  # defp decode_geometry(<<_len::8-little, srid::32-little, 1::8-little, 2::32-little, num_points::32-little, points::binary-size(num_points)-unit(128), rest::bits >>, fields, null_bitfield, acc,  json_library) do
  #   coordinates = decode_points(points)
  #   decode_bin_rows(rest, fields, null_bitfield, [%Mysqlx.Geometry.LineString{srid: srid, coordinates: coordinates} | acc],  json_library)
  # end
  # defp decode_geometry(<<_len::8-little, srid::32-little, 1::8-little, 3::32-little, num_rings::32-little, rest::bits >>, fields, null_bitfield, acc,  json_library) do
  #   decode_rings(rest, num_rings, {srid, fields, null_bitfield, acc},  json_library)
  # end

  # ### GEOMETRY HELPERS

  # defp decode_rings(<< rings_and_rows::bits >>, num_rings, state,  json_library) do
  #   decode_rings(rings_and_rows, num_rings, state, [],  json_library)
  # end
  # defp decode_rings(<< rest::bits >>, 0, {srid, fields, null_bitfield, acc}, rings,  json_library) do
  #   decode_bin_rows(rest, fields, null_bitfield, [%Mysqlx.Geometry.Polygon{coordinates: Enum.reverse(rings), srid: srid} | acc],  json_library)
  # end
  # defp decode_rings(<< num_points::32-little, points::binary-size(num_points)-unit(128), rest::bits >>, num_rings, state, rings,  json_library) do
  #   points = decode_points(points)
  #   decode_rings(rest, num_rings - 1, state, [points | rings],  json_library)
  # end
  ...
  defp decode_text_rows(string, rest, [type | fields], acc, json_library)
    ...
    decode_text_part(
      rest,
      fields,
      [:erlang.binary_to_integer(string) | acc],
      json_library
    )
  end
  ...
  defp decode_text_rows(string, rest, [type | fields], acc, json_library)
    ...
    decode_text_part(
      rest,
      fields,
      [:erlang.binary_to_float(string) | acc],
      json_library
    )
  end
  ...
  defp decode_text_date(
         <<year::4-bytes, ?-, month::2-bytes, ?-, day::2-bytes>>,
         rest,
         fields,
         acc,
         json_library
    ...
    decode_text_part(rest, fields, [date | acc], json_library)
  end

  defp decode_text_time(
         <<hour::2-bytes, ?:, min::2-bytes, ?:, sec::2-bytes>>,
         rest,
         fields,
         acc,
         json_library
    ...
    decode_text_part(rest, fields, [time | acc], json_library)
  end

  defp decode_text_datetime(
         <<year::4-bytes, ?-, month::2-bytes, ?-, day::2-bytes, _::8-little,
           hour::2-bytes, ?:, min::2-bytes, ?:, sec::2-bytes>>,
         rest,
         fields,
         acc,
    ...
    decode_text_part(rest, fields, [datetime | acc], json_library)
  end
